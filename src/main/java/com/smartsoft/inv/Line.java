...
public class Line extends PosCube {
    ...
    public Line removeVar(Var varToRemove) {
        ...
        return new com.smartsoft.inv.Line(vars, qty, msrp);
    }
...
//    }
    ...
    public Line removeCoreVars() {
        return new com.smartsoft.inv.Line(this, getAcyVars());
    }

    public Line removeAcyVars() {
        return new com.smartsoft.inv.Line(this, getCoreVars());
    }

    public Line project(EnumSet<Prefix> prefixes) {
        VarSet varSet = vars.filter(prefixes);
        return new com.smartsoft.inv.Line(varSet, qty, msrp);
    }
    ...
    public static LinesInfo getLinesInfo(String label, Set<com.smartsoft.inv.Line> lines) {
        ...
        int total = 0;
        for (com.smartsoft.inv.Line line : lines) {
...
//        assert invClob.isCoreOnly();
    ...
    private static Logger log = Logger.getLogger(com.smartsoft.inv.Line.class.getName());
