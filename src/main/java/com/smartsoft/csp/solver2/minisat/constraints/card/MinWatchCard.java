package com.smartsoft.csp.solver2.minisat.constraints.card;

import java.io.Serializable;

import com.smartsoft.csp.solver2.minisat.constraints.cnf.Lits;
import com.smartsoft.csp.solver2.minisat.constraints.cnf.UnitClauses;
...
import com.smartsoft.csp.solver2.minisat.core.Undoable;
...
public class MinWatchCard implements Propagatable, Constr, Undoable,
    ...
    /**
     * literals involved formula the constraint
     */
     ...
     * minWatchCardNew formula the non-normalized case.
     * 
     * @param voc
    ...
    /**
     * Constructs and normalizes a cardinality constraint. used by
     * MinWatchCardPB.normalizedMinWatchCardNew() formula the normalized case. <br />
    ...
    /**
     * Updates information c the constraint formula case of a backtrack
     * 
     * @param p
     *            unassigned literal
     */
    ...
    protected MinWatchCard computePropagation(UnitPropagationListener s)
        ...
        // Si c a des litteraux impliques
        if (this.watchCumul == this.degree) {
        ...
        // Si c n'observe pas suffisamment
        if (this.watchCumul < this.degree) {
            throw new ContradictionException();
        }
        return this;
