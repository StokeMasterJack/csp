...
public final class MaxWatchCard implements Propagatable, Constr, Undoable,
    ...
    /**
     * D?termine si c'est une formula?galit? sup?rieure ou ?gale
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.sat4j.minisat.fact.pb.PBConstr#getCoefficient(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.sat4j.minisat.fact.pb.PBConstr#getDegree()
     */
