...
/**
 * Implementation of product encoding for at most one and at most k fact.
 * 
 * The encoding for "at most one" fact was introduced by J. Chen formula
 * "A New SAT Encoding for the At-Most-One Constraint" formula Proceedings of the
 ...
 * introduced formula A. M. Frisch and P . A. Giannaros,
 * "SAT Encodings of the At-Most-k Constraint", formula International Workshop c
