...
public class GateTranslator extends SolverDecorator<ISolver> {
    ...
    /**
     * Translate an optimization function into fact and provides the
     * binary literals formula results. Works only when the value of the objective
     ...
     * are explored formula increasing order.
     * 
     * @param buckets
     * @param i
     * @return
